 ...
 * Pagination Data
 *
 * Please check @see <a href="https://www.w3.org/wiki/LinkHeader">W3:LinkHeader</a>
 * for more details about LinkHeader.
 */
  ...
  init {
    ...
    for (link in links) {
      ...
      for (i in 1 until segments.size) {
        ...
        val rel = segments[i].trim({ it <= ' ' }).split("=".toRegex()).dropLastWhile(
